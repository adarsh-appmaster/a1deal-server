...
const ROLE_META = {
  ...
  master_broker: { label: 'Master Broker', icon: 'verified',   color: 'text-primary',   bg: 'bg-primary/5' },
  ...
  bank:          { label: 'Bank',          icon: 'account_balance', color: 'text-indigo-600', bg: 'bg-indigo-50' },
};
...
export default function PendingApproval() {
  ...
  return (
    ...
    >
      ...
      <h1 className="font-montserrat font-bold text-2xl text-on-surface mb-1">
